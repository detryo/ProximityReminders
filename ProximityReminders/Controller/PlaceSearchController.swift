...
class PlaceSearchController: UIViewController {
    ...
    //If we have selected a place in the tableview, capture the corresponding MKMapItem and arriving/departing setting and save back to the delegate ReminderEditController
